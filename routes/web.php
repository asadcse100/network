...
Route::get('/blogs', 'BlogController@all_blog')->name('blogs');
...
Route::get('/getResourcesAjax', 'ResourcesController@getResourcesAjax')->name('getResourcesAjax');
Route::post('/subscriber/store', 'HomeController@subscriber_store')->name('subscriber.store');
...
Route::get('/login', 'Auth\PublisherLoginController@showLoginForm');
...
Route::group(['prefix' => 'admin',], function () {
  ...
  Route::get('/subscriber/list', 'HomeController@subscriber_list');
  ...
  Route::get('/domain/name/server/settings', 'Users\Admin\SettingsController@domain_name_server');
  Route::get('/landing/settings', 'LandingController@index');
  Route::post('/update-settings', 'Users\Admin\SettingsController@UpdateSettings');
  Route::post('landing/update-settings', 'Users\Admin\SettingsController@UpdateLandingSettings');

  Route::get('privacy/policy', 'Users\Admin\SettingsController@privacy_policy');
  Route::post('privacy/policy/store', 'Users\Admin\SettingsController@privacy_policy_store')->name('privacy_policy.store');
  Route::get('terms/conditions', 'Users\Admin\SettingsController@terms_conditions');  
  Route::post('terms/conditions/store', 'Users\Admin\SettingsController@terms_conditions_store')->name('terms_conditions.store');
  // Route::get('faq', 'Users\Admin\SettingsController@faq');
  ...
  Route::get('/subscriber/{reply?}', 'Users\Admin\AdminController@SubscriberMessage');
  ...
  Route::get('/show-categories', 'Users\Admin\AdminController@ShowCategory')->name('ShowCategory');
