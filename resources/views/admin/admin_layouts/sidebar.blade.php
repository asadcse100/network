    ...
    <div class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul>
                    <li> <a href="{{url('admin/manage-affliatemanager')}}"><i class="bx bx-right-arrow-alt"></i>Affiliate Manager</a>
                    </li>
            ...
            <li>
                ...
                <ul>
                    <li> <a href="{{url('admin/messages')}}"><i class="bx bx-right-arrow-alt"></i>Support Messages</a>
                    </li>
                    <li> <a href="{{url('admin/subscriber/list')}}"><i class="bx bx-right-arrow-alt"></i>Subscriber Messages</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    ...
                    <li> <a href="{{url('admin/manage-cashout-affliate')}}"><i class="bx bx-right-arrow-alt"></i>Affiliate</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{ route('blog.index') }}"> <i class="bx bx-right-arrow-alt"></i> All Posts </a> </li>
                    <li> <a href="{{ route('blog-category.index') }}"> <i class="bx bx-right-arrow-alt"></i> Categories </a> </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{url('admin/settings')}}"> <i class="bx bx-right-arrow-alt"></i> Site Setting </a> </li>
                    <li> <a href="{{url('admin/landing/settings')}}"> <i class="bx bx-right-arrow-alt"></i> Home Landing </a> </li>
                    <li> <a href="{{url('admin/domain/name/server/settings')}}"> <i class="bx bx-right-arrow-alt"></i> Domain Name Server </a> </li>
                    <li> <a href="{{url('admin/privacy/policy')}}"> <i class="bx bx-right-arrow-alt"></i> Privacy & Policy </a> </li>
                    <li> <a href="{{url('admin/terms/conditions')}}"> <i class="bx bx-right-arrow-alt"></i> Terms & Conditions </a> </li>
                    <!-- <li> <a href="{{url('admin/faq')}}"> <i class="bx bx-right-arrow-alt"></i> FAQ </a> </li> -->
                </ul>
            </li>
            <li>
