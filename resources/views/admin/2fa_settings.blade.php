                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            @if($data['user']->adminSecurity == null)
                            <form class="form-horizontal" method="POST" action="{{ route('generate2faSecretadmin') }}">
                                @csrf
                            ...
                            @elseif(!$data['user']->adminSecurity->google2fa_enable)
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('enable2faadmin') }}">
                                @csrf
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('disable2faadmin') }}">
                                @csrf
                                ...
                                <button type="submit" class="btn btn-outline-primary ">Disable 2FA</button>
                            </form>
                            @endif
                        </div>
                    </div>
