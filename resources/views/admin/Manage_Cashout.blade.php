						...
						<div class="row">
							...
							<div class="col-lg-6 col-sm-6">
								<div class="text-right">
									<button class="btn btn-outline-primary" data-toggle="modal" data-target="#addModal">Create Withdrawl Request</button>
								</div>
							</div>
						</div>
					</div>
					<div class="card-body">
						<form id='form1'>
							...
							<div class="row">
								...
								<div class="col-lg-3">
									<button class="btn btn-dark" type="button" id="search">Filter</button>
								</div>
							</div>
						</form>
						<div class="row">
							...
							<!-- ADD MODAL -->
							<form action="{{url('admin/insert-cashout')}}" method="post">
								@csrf
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="row">
													...
													<div class="col-lg-12 form-group">
														<label>Note/Transection Details</label>
							...
							<!-- Edit MODAL -->
							<form action="{{url('admin/update-cashout')}}" method="post">
								@csrf
		...
		<script type="text/javascript">
			$(function() {
				...
				function showdata() {
					$.ajax({
						method: 'get',
						url: '<?php echo url('admin/show-cashout') ?>',
						async: false,
						dataType: 'json',
				...
				$('#showdata').on('click', '.editData', function() {
					...
					$.ajax({
						...
						url: '<?php echo url('admin/edit-cashout') ?>',
						async: false,
						dataType: 'json',
						success: function(res) {
