      ...
      <div class="col-12 ">
        <div class="card">
          <div class="card-header">
            <h4>Pending Publisher </h4>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12 table-responsive">
                <table width="100%" id="datatable" class="table table-sm table-bordered table-striped">
                  <thead>
                    <tr>
                      <th>Id</th>
                      <th>Name</th>
...
<script type="text/javascript">
  $(function() {
    ...
    function showdata() {
      $.ajax({
        method: 'get',
        url: '<?php echo url('affliate/show-pending-publisher') ?>',
        async: false,
        dataType: 'json',
        success: function(res) {
          ...
          for (var i = 0; i < res.length; i++) {
            ...
            html += '<tr>' +
              ...
              '<a href="javascript:;" class=" py-3 approve" data=' + res[i].id + '><li class=py-2>Approve</li> </a>' +
              '<a  href="javascript:;" class=" reject" data=' + res[i].id + '><li class=py-2>Reject</li></a>' +
              ' ' +
              '</ul>' +
              '</div></td>' +
              '</tr>';
