                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            @if($data['user']->affliateSecurity == null)
                            <form class="form-horizontal" method="POST" action="{{ route('generate2faSecretaffliate') }}">
                                @csrf
                            ...
                            @elseif(!$data['user']->affliateSecurity->google2fa_enable)
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('enable2faaffliate') }}">
                                @csrf
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('disable2faaffliate') }}">
                                @csrf
