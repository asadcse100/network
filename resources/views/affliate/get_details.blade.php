      ...
      <div class="col-lg-12 ">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- Edit MODAL -->
            <form action="{{url('affliate/update-publishers')}}" method="post" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <div class="col-lg-6  form-group">
                  ...
                  <select type="text" name="affliate_manager" class="form-control">
                    <option value="">Select Affiliate Manager</option>
                ...
                <div class="col-lg-4">
                  ...
                  <input type="text" class="form-control" value="${{round($qry[0]->total_earnings,2)}}" readonly="">
                </div>
                <div class="col-lg-4">
                  <label>Total withdrawl Amt</label>
                  <input type="text" class="form-control" value="${{round($qry[0]->total_withdrawn,2)}}" readonly="">
                </div>
                <div class="col-lg-4">
                  <label>Total Withdraw </label>
                  <input type="text" class="form-control" value="${{round($qry[0]->no_of_withdrawl,2)}}" readonly="">
                </div>
                <div class="col-lg-4">
                  <label>Locked Withdrawl</label>
                  <input type="text" class="form-control" value="${{round($qry[0]->locked_withdrawl,2)}}" readonly="">
                </div>
                <div class="col-lg-4">
                  <label>Cancelled Withdrawl</label>
                  <input type="text" class="form-control" value="${{round($qry[0]->cancelled_withdrawl,2)}}" readonly="true">
                </div>
