  ...
  $(function() {
    ...
    function searchData() {
      ...
      $.ajax({
        method: 'get',
        data: data,
        url: '<?php echo url('affliate/search-approve-offer-process') ?>',
        async: false,
        dataType: 'json',
        success: function(res) {
          let html = '';
