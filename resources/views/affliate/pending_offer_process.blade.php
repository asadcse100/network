  ...
  $(function() {
    ...
    function searchData() {
      ...
      $.ajax({
        method: 'get',
        data: data,
        url: '<?php echo url('affliate/search-pending-offer-process') ?>',
        async: false,
        dataType: 'json',
        success: function(res) {
          let html = '';
          ...
          for (var i = 0; i < res.length; i++) {
            ...
            html += '<tr>' +
              ...
              ' <a class="dropdown-item rejectSelected"  type="button" >Reject Selected</a>' +
              ...
              '<a class="dropdown-item rejectAll"   type="button">Reject All</a>' +
