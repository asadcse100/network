      ...
      <div class="col-lg-12 ">
        <div class="card">
          <div class="card-header">
            <h5 class="mb-0">Filter Public Offers</h5>
          </div>
          <div class="card-body">
            <form action="{{url('publisher/offer/search')}}" method="get">
              ...
              <div class="row">
                <div class="col-lg-12 mb-3">
                  ...
                  <div slider id="slider-distance " style="margin: 0px!important;margin-bottom: 20px!important;">
                    ...
                    <input type="range" tabindex="0" value="0" max="100" min="0" name="from_payout" step="1" oninput="this.value=Math.min(this.value,this.parentNode.childNodes[5].value-1);
              ...
              <input type="hidden" name="offer_type" value="public">
            </form>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-header">
            <h5 class="mb-0">View Public Offers</h5>
          </div>
          <div class="card-body">
                ...
                <tbody id="showdata">
                  ...
                  foreach ($offers as $offer) { ?>
                    <tr>
                      ...
                      <td><a class="btn btn-primary" href="{{url('publisher/offers-details')}}/{{$offer->id}}" target="_blank">Get Details</a></td>
                    </tr>
                  <?php }
                  ?>
                </tbody>
  ...
  $(function() {
    $('#search').click(function() {
      ...
      $.ajax({
        method: 'get',
        data: data,
        url: '<?php echo url('publisher/search-offer') ?>',
        async: false,
        dataType: 'json',
        success: function(res) {
          ...
          for (var i = 0; i < res.length; i++) {
            ...
            html += '<tr>' +
              ...
              '<td>' + browsericon + '</td>' +
              '<td><a class="btn btn-primary" href="{{url("publisher/offers-details")}}/{{@$q->oid}}" target="_blank"  data=' + res[i].id + '>Get Details </a> </td>' +
              '</tr>';
          }
