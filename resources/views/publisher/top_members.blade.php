...
<div class="page-content">
							...
							<div class="media align-items-center">
								...
								<div class="media-body ml-3">
									...
									<p class="designattion mb-0">
										...
										<div class='badge badge-light'>Beginner</div>
										@elseif ($d->publisher_earnings >= 10 && $d->publisher_earnings < 35)
										<div class='badge badge-info'>Expert</div>
										@elseif ($d->publisher_earnings >= 35 && $d->publisher_earnings < 100)
										<div class='badge badge-warning'>Genious</div>
										 @elseif ($d->publisher_earnings >= 100 && $d->publisher_earnings < 1000)
										<div class='badge badge-dark'>Boss</div>
										@elseif ($d->publisher_earnings >= 1000 && $d->publisher_earnings < 15000)
										<div class='badge badge-danger'>Rock</div>
										@elseif ($d->publisher_earnings >= 15000)
										<div class='badge badge-success'>Superman</div>
										@endif
									</p>
									<div class="list-inline contacts-social mt-2">
										<div>
											<span class="mr-2"><b> Leads : </b>{{$d->leads==null?0:$d->leads}}</span><br> <span class="mr-2"><b> Clicks : </b>
												@foreach ($clicks as $c)
										...
										<span class="mr-2"><b> Total Leads : </b>{{$d->total_leads==null?0:$d->total_leads}}</span><br> <span class="mr-2"><b>Total Clicks :</b>
											<?php
								...
								<div class="col-lg-5">
									<div class="card bg-info  text-center " style="width: 49%;float:left">
										<div class="card-body">
									...
									<div class="card text-center" style="width: 49%;float:right;background-color: #11a976">
										<div class="card-body">
											<div class="text-center">
												<div class="font-60 text-white">
												</div>
		...
		<div class="col-lg-6">
			...
			@if($count<=10) <div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<div class="media align-items-center">
							@if($d->publisher_image!=null)
