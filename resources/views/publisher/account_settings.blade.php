              ...
              <div class="d-md-flex align-items-center">
                <div class="mb-md-0 mb-3">
                  <form id="form1" action="{{url('publisher/upload-image')}}" method="post" enctype="multipart/form-data">
                    ...
                    <p><label for="file" style="cursor: pointer;">
                        ...
                        @else
                        <img src="{{asset('cdn')}}/site/dashboard_assets/images/avatars/avatar-1.png" class="rounded-circle shadow" width="130" height="130" alt="">
                        @endif
                      </label></p>
                  </form>
                </div>
                <div class="ml-md-4 flex-grow-1">
                  ...
                  <p class="text-primary"><i class='bx bx-buildings'></i>
                    @if ($qry->total_earnings < 10) Beginner @elseif ($qry->total_earnings >= 10 && $qry->total_earnings < 35) Expert @elseif ($qry->total_earnings >= 35 && $qry->total_earnings < 100) Genious @elseif ($qry->total_earnings >= 100 && $qry->total_earnings < 1000) Boss @elseif ($qry->total_earnings >= 1000 && $qry->total_earnings < 15000) Rock @elseif ($qry->total_earnings >= 15000)
                              Superman
                              @endif
                  </p>
                </div>
              ...
              <div class="card text-center">
                <div class="card-body px-0">
                  <div class="text-center">
                    ...
                    <h4 class="mb-0">${{round($qry->balance,2)}}</h4>
              ...
              <div class="card text-center">
                <div class="card-body px-0">
                  <div class="text-center">
                    ...
                    <h4 class="mb-0">${{round($qry->total_earnings,2)}}</h4>
                  ...
                  <div class="row">
                    ...
                    <div class="row" id="showdata">
                      ...
                      <div class="col-12 col-lg-6 mb-3">
                        <div class="card shadow-none border mb-md-0">
                          <div class="card-body">
                          ...
                          <div class="card-footer bg-transparent "><a href="javaScript:;" class="text-danger removepayment" style="float:right" data="{{$p->id}}">REMOVE</a>
                          </div>
                        </div>
                      </div>
