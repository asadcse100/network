            ...
            <div class="col-lg-12 ">
                <div class="card" style="box-shadow: 0 4px 8px 0 rgb(146 140 175);transition: 0.3s;border: 1px solid #ffefef;">
                    ...
                    <div class="card-body">
                        ...
                        @endphp
                        <p class="postback"><code>{ip_address}</code> - @if(!empty($site_setting->site_name)){{ $site_setting->site_name }}@endif Ip Address from Visitor. </p>
                        <p class="postback"><code>{ua_target}</code> - @if(!empty($site_setting->site_name)){{ $site_setting->site_name }}@endif Device Name. from Visitor </p>
                        <p class="postback"><code>{browsers}</code> - @if(!empty($site_setting->site_name)){{ $site_setting->site_name }}@endif Browsers Name. from Visitor </p>
                    </div>
                </div>
            </div>
        </div>
