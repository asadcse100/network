...
@section('css')
<link href="{{asset('cdn/site/css/bootstrap-slider.css')}}" rel="stylesheet">
               ...
               <div class="row">
                 <div class="col-lg-12 mb-3">
                   ...
                   <div slider id="slider-distance " style="margin: 0px!important;margin-bottom: 20px!important;">
                     ...
                     <input type="range" tabindex="0" value="0" max="100" min="0" name="from_payout" step="1"
                 ...
                 <div class="col-lg-3">
                   ...
                   <select name="category[]" class="js-example-basic-multiple" multiple data-actions-box="true" style="width: 100%">
                     <?php
