<section id="about">
  <div class="content bg-white block-about-1 padding-top-140 padding-bot-30">
    <div class="container text-left">
      ...
      <div class="row padding-top-50">
        <div class="col-sm-6"> <img class="img-responsive scroll-animated-from-bottom" src="{{asset('/assets/img/about/1.jpg')}}" alt="image">
          <p class="scroll-animated-from-bottom"> {!! $about_para2 !!} </p>
          <div class="container-video scroll-animated-from-bottom"> <a class="cbp-lightbox" href="https://vimeo.com/109777877"> <span class="">
          <svg version="1.1" id="_x36_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 512 512"  xml:space="preserve">
<g>
	<g>
		<rect style="fill:#57646D;" width="80" height="80"/>
		<g>
			<g>
	...
	<polygon style="opacity:0.08;fill:#040000;" points="512,0 512,404.352 53.824,404.352 458.176,0 	"/>
              ...
              </span> </a> <img class="img-responsive" src="{{asset('/assets/img/about/2.jpg')}}" alt="image"> </div>
        </div>
        <div class="col-sm-6">
          <h3 class="scroll-animated-from-bottom"> {!! $about_heading !!}</h3>
          <p class="scroll-animated-from-bottom">{!! $about_para1 !!} </p><img class="img-responsive scroll-animated-from-bottom" src="{{asset('/assets/img/about/3.jpg')}}" alt="Edit me">
        </div>
      </div>
    </div>
  </div>
