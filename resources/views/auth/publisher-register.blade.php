...
<head>
  ...
  <title>{{ config('app.name') }} - Publisher Register</title>
  <!--favicon-->

  <link href="{{asset('cdn')}}/site/dashboard_assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
  <link href="{{asset('cdn')}}/site/dashboard_assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" />
  <link href="{{asset('cdn')}}/site/dashboard_assets/plugins/metismenu/css/metisMenu.min.css" rel="stylesheet" />
  <link href="{{asset('cdn')}}/site/dashboard_assets/plugins/smart-wizard/css/smart_wizard_all.min.css" rel="stylesheet" type="text/css" />
  <!-- loader-->
  <link href="{{asset('cdn')}}/site/dashboard_assets/css/pace.min.css" rel="stylesheet" />
  <script src="{{asset('cdn')}}/site/dashboard_assets/js/pace.min.js"></script>
  <!-- Bootstrap CSS -->
  <link rel="stylesheet" href="{{asset('cdn')}}/site/dashboard_assets/css/bootstrap.min.css" />
  <!-- Icons CSS -->
  <link rel="stylesheet" href="{{asset('cdn')}}/site/dashboard_assets/css/icons.css" />
  <!-- App CSS -->
  <link rel="stylesheet" href="{{asset('cdn')}}/site/dashboard_assets/css/app.css" />
  <link rel="stylesheet" href="{{asset('cdn')}}/site/dashboard_assets/css/dark-style.css" />
  <style type="text/css">
    #smartwizard {
...
<body>
      ...
      <div class="container-fluid mt-5">
        <div class="row no-gutters">
          <div class="col-lg-6  d-flex align-items-stretch m-auto">
            <div class="card mb-0" style="height: 100%;width: 100%">
              <div class="card-body p-md-5 text-center">
                <img src="@if(!empty(DB::table('site_settings')->first()->logo)){{asset('site_images')}}/{{DB::table('site_settings')->first()->logo}}@endif" width="180" alt="" />
                    ...
                    <div id="smartwizard">
                      ...
                      <div class="tab-content">
                        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                          ...
                          <div class="col-lg-7" id="account_type_hidden" style="visibility:hidden">
                            <div class="form-group">
                        ...
                        <div id="step-4" class="tab-pane" role="tabpanel" aria-labelledby="step-4">
                          ...
                          <p class="text-start">
                            <input type="checkbox" name="terms" checked="" value="1" readonly="true"><b style="font-size: 18px">
                              By submitting this form, You agree to Our <a href="/privacy/">Privacy Policy</a> and <a href="/terms/">Our Terms and Conditions</a></b></p> 
                            <br>
                            <p class="text-start">
                              <input type="checkbox" name="updates" checked="" value="1" readonly="true">
                            <b style="font-size: 18px"> Yes! Send me updates and Notificatios</b></p>
                          </div>
                        </div>
  ...
  <p class="m-auto text-center " style="margin-top: 20px!important"><b>&copy; Copyright {{ config('app.name') }} </b></p>
  <!-- end wrapper -->

  <!-- JavaScript -->
  <!-- jQuery first, then Popper.js, then Bootstrap JS -->
  <script src="https://code.jquery.com/jquery-3.5.0.min.js"></script>
  <script src="{{asset('cdn')}}/site/dashboard_assets/js/popper.min.js"></script>
  <script src="{{asset('cdn')}}/site/dashboard_assets/js/bootstrap.min.js"></script>
  <!--plugins-->
  <script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
  <script src="{{asset('cdn')}}/site/dashboard_assets/plugins/simplebar/js/simplebar.min.js"></script>
  <script src="{{asset('cdn')}}/site/dashboard_assets/plugins/metismenu/js/metisMenu.min.js"></script>
  <script src="{{asset('cdn')}}/site/dashboard_assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js"></script>
  <script src="{{asset('cdn')}}/site/dashboard_assets/plugins/smart-wizard/js/jquery.smartWizard.min.js"></script>
  <!DOCTYPE html>
  <html>
  ...
  <!-- App JS -->
  <script src="{{asset('cdn')}}/site/assets/js/app.js"></script>
</body>
